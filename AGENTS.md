...
The project uses **[TypeDoc](https://typedoc.org/)** to generate a static HTML reference from JSDoc comments in the source code. Output lives in `./docs/` (gitignored — regenerated by `pnpm run docs`).

**Scripts:**

- `pnpm run docs` — generate the static site
